...
public class ContentController {
    ...
    // 3. 목록 조회
    @GetMapping
    public ResponseEntity<CommonResponse<List<ContentResponseDto>>> getAllContent(@AuthenticationPrincipal UserDetailsImpl userDetails) {
        return ResponseEntity.ok(CommonResponse.success(CommonCode.SUCCESS, contentService.findAllContent(userDetails.getMember().getId())));
    }
